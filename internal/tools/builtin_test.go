...
func TestRegisterBuiltinsRegistersAllTools(t *testing.T) {
	...
	expectedTools := []string{"read", "write", "edit", "glob", "grep", "ls", "shell", "mkdir", "tree", "fetch", "run", "sysinfo", "find_replace", "git", "patch", "replace_all", "diff", "clipboard", "websearch", "wikipedia", "weather", "convert", "currency", "notes", "todos", "filefinder", "summarize", "rss", "coderunner", "calendar", "email", "screenshot", "volume", "brightness", "notify", "timer", "app", "hash", "dict", "netcheck", "translate", "qrcode", "archive", "diskusage", "process", "calculator", "password", "bookmarks", "journal", "habits", "expenses"}
	tools := r.List()
